  ...
  if (loading) {
    return (
      <div className="premium-loading-screen">
        ...
        <p className="loading-text">Cargando información corporativa...</p>
      </div>
    );
  }
    ...
    <div className="premium-container">
      ...
      <div className="premium-card">
        ...
        <div className="sections-grid">
          {/* Sección Misión */}
          <div className="premium-section mission-section always-visible">
          ...
          {/* Sección Visión */}
          <div className="premium-section vision-section always-visible">
            <div className="section-header">
          ...
          {/* Sección Valores */}
          <div className="premium-section values-section always-visible">
            <div className="section-header">
          ...
          {/* Sección Políticas */}
          <div className="premium-section policies-section always-visible">
            <div className="section-header">
            ...
            <div className="section-content">
              {politicas.length > 0 ? (
                politicas.slice(0, 2).map(politica => (
                  <p key={politica._id} className="section-text">{politica.descripcion}</p>
                ))
              ) : (
                <p className="section-text">No hay políticas disponibles</p>
              )}

              <div className="section-footer">
                <Link to="/politicas" className="section-badge">
