...
// Configuración del ícono del marcador mejorado
const icon = L.icon({
  ...
  return (
    <div className="premium-container">
      ...
      <div className="premium-card">
        {/* Banner de Bienvenida estilo app móvil */}
        ...
        {/* FAQ Section - Ahora en formato de pila vertical */}
      ...
      <style>{`
        ...
        /* Hero Section Styles - Estilo app móvil */
        .hero-section {
          position: relative;
          border-radius: 15px;
          overflow: hidden;
        ...
        /* FAQ Section Styles - formato de pila vertical */
        .faq-section {
          margin-bottom: 2rem;
        }
